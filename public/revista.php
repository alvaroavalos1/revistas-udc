  ...
  <div class="article">
    <div class="article-cover">
      <?php if ($revista['portada_url']): ?>
        <img src="<?= htmlspecialchars(str_starts_with($revista['portada_url'], 'http') ? $revista['portada_url'] : '../' . $revista['portada_url']) ?>" alt="Portada" onerror="this.style.display='none'">
      <?php else: ?>
        📄
      <?php endif; ?>
            ...
            <a class="rel-item" href="revista.php?id=<?= $rel['revista_id'] ?>&lang=<?= $lang ?>">
              <div class="rel-img">
                <?php if (!empty($rel['portada_url'])): ?>
                  <img src="<?= htmlspecialchars(str_starts_with($rel['portada_url'], 'http') ? $rel['portada_url'] : '../' . $rel['portada_url']) ?>" alt="" onerror="this.style.display='none'">
                <?php else: ?>
                  📄
                <?php endif; ?>
              </div>
